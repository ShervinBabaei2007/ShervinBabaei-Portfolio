// =====================
// PROJECT DATA
// Edit this to match your actual projects.
// Each "folder" must match the folder name inside /projects/
// =====================
const projects = [
  {
    name: "GitScribe",
  ...
  },
  {
    name: "Jeddit",
    folder: "jeddit",
    desc: "A Reddit-like web app with voting, custom ordering, moderator management, and nested comments. Built with Node.js, Express, and EJS.",
...
function renderProjects() {
  ...
  projects.forEach(function(project, index) {
    ...
    card.innerHTML =
      ...
      "<a href='" + projectPath + "' class='project-link'>View Project</a>";
